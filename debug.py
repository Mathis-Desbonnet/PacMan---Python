        ...
        if self.blinkyLife <= 2:
            ...
            for i in self.blinky.okMovement:
                ...
                if i == "Right":
                    ...
                    pygame.draw.rect(
                        self.screen, (255, 0, 0), self.blinky.collisionBox, 1
                    )
                    pygame.display.flip()
                    for collision in self.collisions:
                ...
                if i == "Right":
                    ...
                    self.pinkyDistance = sqrt(
                        (
                            ...
                            - (self.pacman.rect.x + self.pinkyDirectionAddition[0])
                        )
                        ** 2
                        + (
                            self.pinky.collisionBox.y
                            - (self.pacman.rect.y + self.pinkyDirectionAddition[1])
                        )
                        ** 2
                    )
                    pygame.draw.rect(
                        self.screen, (188, 0, 255), self.pinky.collisionBox, 1
                    )
                    pygame.display.flip()
                    for collision in self.collisions:
        ...
        if self.inkyLife >= 0:
            ...
            for i in self.inky.okMovement:
                ...
                if i == "Right":
                    ...
                    pygame.draw.rect(
                        self.screen, (0, 255, 255), self.inky.collisionBox, 1
                    )
                    pygame.display.flip()
                    for collision in self.collisions:
        ...
        if self.clydeLife >= 0:
            ...
            for i in self.clyde.okMovement:
                ...
                if i == "Right":
                    ...
                    pygame.draw.rect(
                        self.screen, (255, 0, 0), self.clyde.collisionBox, 1
                    )
                    pygame.display.flip()
                    for collision in self.collisions:
